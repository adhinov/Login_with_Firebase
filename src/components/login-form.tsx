...
import Link from "next/link" // ✅ pakai next/link
                  ...
                  <div className="relative">
                    <FormControl>
                      <div className="relative">
                        ...
                        />
                        <FormLabel className="absolute text-base text-muted-foreground duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-card px-2 left-9 peer-placeholder-shown:scale-100 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 pointer-events-none">
                          Email
                        </FormLabel>
                      </div>
                    </FormControl>
