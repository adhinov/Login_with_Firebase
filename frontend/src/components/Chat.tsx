...
import io from "socket.io-client"; // ✅ default import untuk versi lama
...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    // ✅ koneksi socket versi lama (tidak pakai auth property)
  ...
  const sendMessage = () => {
    ...
    const receiver_id = prompt("Masukkan ID penerima:");
    if (!input || !receiver_id || !sender_id) return;
